...
@section('content')
    <section class="container-fluid" style="font-family: cairo light;">
        <div class="row" style="display: flex;justify-content: center;flex-wrap: wrap;align-items: center;gap: 20px;margin-top: 30px;">
                ...
                <div class="col-md-3" style="box-shadow: 0px 0px 7px 3px #eee;">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('Order', $maid) }}" class="theme_button muted_button">{{__('home.the details')}} </a>
                        </div>
                        @if ($maid->order)
