<header class="page_header header_white floating_logo table_section" >
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-xs-10 text-right textRight"style="color:#103f55;  font-family: cairo light;">
                ...
                @if (app()->getLocale() == 'ar')
                    <a href="{{ route('en') }}" class="syria lang-switcher" style="color:#103f55;     padding: 10px;">

                        En
                    </a>
                @else
                    <a href="{{ route('ar') }}" class="lang-switcher" style="color:#103f55; padding: 22px; margin-right: 40px;">
                        Ar
                    </a>
                @endif
                {{-- {{ Auth::user()->roles }} --}}
